...
And('Select Mode of Transport to edit', () => {
    cy.get(':nth-child(2) > :nth-child(5) > .row > .col-12 > .anticon > svg').click();
    cy.wait(1000);
})

And('Edit information Mode of Transport', () => {
    //Input Mode of Transport code
    cy.get('[style="padding: 25px 15px 10px;"] > .ant-col-5 > .ant-input').clear().type('18');
    cy.wait(1000);
    //Input Mode of Transport name
    cy.get(':nth-child(3) > .ant-col-5 > .ant-input').clear().type('EDIT2')
    cy.wait(1000);
})
