Feature: Export Custom Broker Performance Dashboard
...
#     Then Click menu export custom broker performance dashboard
...
# Scenario: case3: ทดสอบส่วนการค้นหากรณีค้นหาตาม Submission Date บริษัท และสาขา
    # Given Open Website "https://thetiffa.tiffaedi.net/"
    # When Input user "o.akrad.ttt08@gmail.com" and password "1"
    # And Click Button login
